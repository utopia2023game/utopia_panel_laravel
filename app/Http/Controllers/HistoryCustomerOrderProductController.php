...
class HistoryCustomerOrderProductController extends Controller
{
    public function set_hc_order_product_table_refresh_all()
    {
        ...
        for ($i = 0; $i < count($customer); $i++) {
            ...
            for ($j = 0; $j < count($order); $j++) {
                ...
                HistoryCustomerOrderProductController::set_data_history_customer_order_product($customer[$i]->id, $product_id, $order[$j]);
            }
    ...
    public static function set_data_history_customer_order_product($customer_id, $product_id, $order)
    {
        for ($i = 0; $i < count($product_id); $i++) {
            ...
            if (HistoryCustomerOrderProduct::where('customer_id', $customer_id)->where('product_id', $product_id[$i])->exists()) {
                ...
                $all_purchase_pressture_day = HistoryCustomerOrderProductController::get_pressture_day($all_purchase_sequence_day);
                $all_purchase_power_in_month = HistoryCustomerOrderProductController::get_power_in_month($all_purchase_date);
                $all_purchase_power_in_year = HistoryCustomerOrderProductController::get_power_in_year($all_purchase_date);
                ...
                if ($order_status_id <= 5) {
                    ...
                    $pending_purchase_power_in_month = HistoryCustomerOrderProductController::get_power_in_month($pending_purchase_date);
                    $pending_purchase_power_in_year = HistoryCustomerOrderProductController::get_power_in_year($pending_purchase_date);
                    ...
                    $canceled_purchase_power_in_month = HistoryCustomerOrderProductController::get_power_in_month($canceled_purchase_date);
                    $canceled_purchase_power_in_year = HistoryCustomerOrderProductController::get_power_in_year($canceled_purchase_date);
                    ...
                    $returned_purchase_power_in_month = HistoryCustomerOrderProductController::get_power_in_month($returned_purchase_date);
                    $returned_purchase_power_in_year = HistoryCustomerOrderProductController::get_power_in_year($returned_purchase_date);
                    ...
                    $delivered_purchase_power_in_month = HistoryCustomerOrderProductController::get_power_in_month($delivered_purchase_date);
                    $delivered_purchase_power_in_year = HistoryCustomerOrderProductController::get_power_in_year($delivered_purchase_date);
                ...
                $all_purchase_power_in_month = HistoryCustomerOrderProductController::get_power_in_month([$order->created_at]);
                $all_purchase_power_in_year = HistoryCustomerOrderProductController::get_power_in_year([$order->created_at]);
    ...
    public static function get_pressture_day($all_purchase_sequence_day)
    {
    ...
    public static function get_power_in_month($all_purchase_date)
    {
        $xStart = 0;
        $xMiddle = 0;
        $xEnd = 0;
    ...
    public static function get_power_in_year($all_purchase_date)
    {
        $xStart = 0;
        $xMiddle = 0;
        $xEnd = 0;
    ...
    public static function update_data_history_customer_order_product($customer_id, $product_id, $order, $order_status_id, $order_status_id_old)
    {
        for ($i = 0; $i < count($product_id); $i++) {
